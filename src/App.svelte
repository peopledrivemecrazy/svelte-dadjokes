...
<main>
	...
	<div class="text-center">
		...
		<p>....</p>
		<p>{punchline}</p>
		<h3 class="hidden-xs">Press Enter/Space for a new joke!</h3>

		<h3 class="sign">👨 Jokes with
			<svg id="svelte" xmlns="http://www.w3.org/2000/svg" width="300" height="139" viewBox="0 0 519 139">
				<path id="logotype" fill="#4a4a55"
		...
		<button on:click={fetchJoke}>Get me one more!</button>
	</div>
...
<footer class="text-center">
	from <a href="https://anoram.com">Anoram</a>
</footer>
<style>
	main {
		margin-top: 5em;
