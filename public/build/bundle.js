    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file, 32, 2, 592);
    			attr_dev(p1, "class", "svelte-1bg3mov");
    			add_location(p1, file, 33, 2, 610);
    			attr_dev(p2, "class", "svelte-1bg3mov");
    			add_location(p2, file, 34, 2, 623);
    			attr_dev(p3, "class", "svelte-1bg3mov");
    			add_location(p3, file, 35, 2, 638);
    			attr_dev(h30, "class", "hidden-xs svelte-1bg3mov");
    			add_location(h30, file, 36, 2, 660);
    			...
    			add_location(path0, file, 40, 4, 866);
    			...
    			add_location(path1, file, 42, 4, 2177);
